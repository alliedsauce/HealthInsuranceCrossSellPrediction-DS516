...
งานนี้มีวัตถุประสงค์เพื่อพัฒนาโมเดล Machine Learning ในการทำนายลูกค้าประกันสุขภาพที่มีแนวโน้มสนใจซื้อประกันรถยนต์ โดยจัดการปัญหาข้อมูลไม่สมดุลและให้ความสำคัญกับสมดุลระหว่าง Precision และ Recall เพื่อให้เหมาะสมต่อการนำไปใช้งานจริงเชิงธุรกิจ

---

## 🎯 วัตถุประสงค์ (Objectives)
1. เพื่อพัฒนาและเปรียบเทียบแบบจำลอง Machine Learning สำหรับการทำนายลูกค้าประกันสุขภาพที่มีแนวโน้มสนใจซื้อประกันรถยนต์
2. เพื่อจัดการกับปัญหาข้อมูลที่ไม่สมดุล (Class Imbalance) และศึกษาผลกระทบของเทคนิคที่ใช้ต่อประสิทธิภาพของแบบจำลอง
3. เพื่อปรับแต่งพารามิเตอร์ของแบบจำลองอย่างเป็นระบบ รวมถึงการปรับแต่งเชิงลึก (Deep Tuning) เพื่อเพิ่มประสิทธิภาพในการจำแนกคลาสเป้าหมาย
4. เพื่อประเมินและคัดเลือกแบบจำลองที่มีความเหมาะสมที่สุด โดยพิจารณาจากตัวชี้วัดด้านประสิทธิภาพ และสมดุลระหว่าง Precision และ Recall
5. เพื่อเลือกแบบจำลองที่เหมาะสมสำหรับการนำไปใช้งานจริง และสามารถสนับสนุนการตัดสินใจเชิงธุรกิจได้อย่างมีประสิทธิภาพ
...
ใช้สำหรับฝึกโมเดลด้วย pipeline โดยไม่ใช้ GridSearchCV สำหรับการทดลองโมเดล baseline
